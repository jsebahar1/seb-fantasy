...
export const INITIAL_GAMES = [
  ...
  { home: 'Kansas',            away: 'Missouri',         homePoints: 21, awayPoints: 38 },
  { home: 'Louisville',        away: 'FCS',              homePoints: 59, awayPoints: 13 },
  { home: 'Virginia',          away: 'FCS',              homePoints: 59, awayPoints:  3 },
  { home: 'NC State',          away: 'FCS',              homePoints: 73, awayPoints:  0 },
  { home: 'Boston College',    away: 'Rutgers',          homePoints: 28, awayPoints: 21 },
  { home: 'Georgia',           away: 'Western Kentucky', homePoints: 70, awayPoints: 20 },
  { home: 'Notre Dame',        away: 'Rice',             homePoints: 52, awayPoints:  0 },
  { home: 'Oklahoma State',    away: 'Oregon',           homePoints: 39, awayPoints: 31 },
  { home: 'Texas A&M',         away: 'Arizona State',    homePoints: 48, awayPoints: 20 },
  { home: 'Michigan',          away: 'Oklahoma',         homePoints: 17, awayPoints: 10 },
  { home: 'Kentucky',          away: 'Alabama',          homePoints: 17, awayPoints: 45 },
  { home: 'BYU',               away: 'Arizona',          homePoints: 28, awayPoints: 17 },
  { home: 'Temple',            away: 'Penn State',       homePoints:  9, awayPoints: 27 },
  { home: 'Washington',        away: 'Utah State',       homePoints: 16, awayPoints: 14 },
  { home: 'Liberty',           away: 'FCS',              homePoints: 24, awayPoints: 23 },
  { home: 'Kansas State',      away: 'Washington State', homePoints: 34, awayPoints:  7 },
  { home: 'North Carolina',    away: 'FCS',              homePoints: 35, awayPoints:  3 },
  { home: 'Kent State',        away: 'FCS',              homePoints: 36, awayPoints: 15 },
  { home: 'East Carolina',     away: 'Appalachian State',homePoints: 24, awayPoints: 27 },
  { home: 'James Madison',     away: 'FCS',              homePoints: 87, awayPoints:  3 },
  { home: 'Purdue',            away: 'Wake Forest',      homePoints: 36, awayPoints: 38 },
  { home: 'Army',              away: 'South Florida',    homePoints: 24, awayPoints: 28 },
  { home: 'Virginia Tech',     away: 'Old Dominion',     homePoints: 44, awayPoints: 21 },
  { home: 'West Virginia',     away: 'FCS',              homePoints: 52, awayPoints:  7 },
  { home: 'Miami (OH)',        away: 'FCS',              homePoints: 45, awayPoints:  7 },
  { home: 'Central Michigan',  away: 'FCS',              homePoints: 13, awayPoints: 10 },
  { home: 'Ball State',        away: 'FCS',              homePoints: 41, awayPoints: 17 },
  { home: 'Illinois',          away: 'Duke',             homePoints: 27, awayPoints: 31 },
  { home: 'Minnesota',         away: 'Mississippi State',homePoints: 13, awayPoints: 38 },
  { home: 'Michigan State',    away: 'Eastern Michigan', homePoints: 35, awayPoints:  7 },
  { home: 'Akron',             away: 'FCS',              homePoints: 45, awayPoints: 10 },
  { home: 'Toledo',            away: 'FCS',              homePoints: 63, awayPoints: 10 },
  { home: 'UConn',             away: 'Maryland',         homePoints: 14, awayPoints: 38 },
  { home: 'UMass',             away: 'FCS',              homePoints: 37, awayPoints: 10 },
  { home: 'North Texas',       away: 'UNLV',             homePoints: 44, awayPoints:  6 },
  { home: 'New Mexico',        away: 'FCS',              homePoints: 70, awayPoints:  7 },
  { home: 'Texas',              away: 'Ohio State',           homePoints: 24, awayPoints: 23 },
  { home: 'Indiana',            away: 'FCS',                  homePoints: 55, awayPoints:  0 },
  { home: 'LSU',                away: 'Louisiana Tech',       homePoints: 45, awayPoints: 14 },
  { home: 'Ole Miss',           away: 'Charlotte',            homePoints: 41, awayPoints:  9 },
  { home: 'Oregon State',       away: 'Texas Tech',           homePoints: 24, awayPoints: 35 },
  { home: 'USC',                away: 'Louisiana',            homePoints: 49, awayPoints: 30 },
  { home: 'SMU',                away: 'FCS',                  homePoints: 56, awayPoints: 10 },
  { home: 'Georgia Tech',       away: 'Tennessee',            homePoints: 24, awayPoints: 45 },
  { home: 'Utah',               away: 'Arkansas',             homePoints: 43, awayPoints: 10 },
  { home: 'Iowa',               away: 'Iowa State',           homePoints: 16, awayPoints: 13 },
  { home: 'Houston',            away: 'FCS',                  homePoints: 77, awayPoints:  6 },
  { home: 'Texas State',        away: 'UTSA',                 homePoints: 26, awayPoints: 31 },
  { home: 'Colorado',           away: 'FCS',                  homePoints: 52, awayPoints: 21 },
  { home: 'Syracuse',           away: 'California',           homePoints: 18, awayPoints: 21 },
  { home: 'Pittsburgh',         away: 'UCF',                  homePoints: 12, awayPoints:  7 },
  { home: 'UAB',                away: 'Louisiana Monroe',     homePoints: 26, awayPoints: 20 },
  { home: 'Wyoming',            away: 'FCS',                  homePoints: 21, awayPoints: 13 },
  { home: 'Troy',               away: 'FCS',                  homePoints: 34, awayPoints: 17 },
  { home: 'Vanderbilt',         away: 'Delaware',             homePoints: 35, awayPoints: 26 },
  { home: 'Florida',            away: 'FCS',                  homePoints: 52, awayPoints:  3 },
  { home: 'Ohio',               away: 'Jacksonville State',   homePoints: 29, awayPoints: 27 },
  { home: 'Boise State',        away: 'Memphis',              homePoints: 38, awayPoints: 20 },
  { home: 'FIU',                away: 'Buffalo',              homePoints: 33, awayPoints: 20 },
  { home: 'Western Michigan',   away: 'FCS',                  homePoints: 49, awayPoints: 14 },
  { home: 'Marshall',           away: 'Middle Tennessee',     homePoints: 28, awayPoints: 26 },
  { home: 'Nebraska',           away: 'Bowling Green',        homePoints: 56, awayPoints:  7 },
  { home: 'Sam Houston',        away: 'Tulsa',                homePoints: 17, awayPoints: 23 },
  { home: 'Northern Illinois',  away: 'FCS',                  homePoints: 24, awayPoints: 28 },
  { home: 'Tulane',             away: 'South Alabama',        homePoints: 28, awayPoints: 24 },
  { home: 'Arkansas State',     away: 'FCS',                  homePoints: 52, awayPoints:  7 },
  { home: 'Missouri State',     away: 'FCS',                  homePoints: 48, awayPoints: 14 },
  { home: 'South Carolina',     away: 'FCS',                  homePoints: 45, awayPoints:  9 },
  { home: 'Colorado State',     away: 'FCS',                  homePoints: 58, awayPoints: 24 },
  { home: 'Kennesaw State',     away: 'Georgia State',        homePoints: 17, awayPoints: 31 },
  { home: 'Cincinnati',         away: 'FCS',                  homePoints: 62, awayPoints: 10 },
  { home: 'UCLA',               away: 'San Diego State',      homePoints: 28, awayPoints: 10 },
  { home: 'Wisconsin',          away: 'FCS',                  homePoints: 36, awayPoints:  9 },
  { home: 'Auburn',             away: 'Southern Miss',        homePoints: 43, awayPoints:  8 },
  { home: 'Florida Atlantic',   away: 'Navy',                 homePoints: 38, awayPoints: 30 },
  { home: 'Coastal Carolina',   away: 'FCS',                  homePoints: 45, awayPoints:  7 },
  { home: 'Clemson',            away: 'Georgia Southern',     homePoints: 22, awayPoints:  7 },
  { home: 'TCU',                away: 'FCS',                  homePoints: 63, awayPoints:  7 },
  { home: 'Baylor',             away: 'FCS',                  homePoints: 44, awayPoints:  3 },
  { home: 'UTEP',               away: 'FCS',                  homePoints: 51, awayPoints: 10 },
  { home: 'San Jose State',     away: 'FCS',                  homePoints: 30, awayPoints: 20 },
  { home: 'Air Force',          away: 'North Dakota State',   homePoints: 32, awayPoints: 38 },
  { home: 'Nevada',             away: 'FCS',                  homePoints:  7, awayPoints: 20 },
  { home: 'Fresno State',       away: 'Sacramento State',     homePoints: 49, awayPoints:  3 },
  { home: 'Hawaii',             away: 'New Mexico State',     homePoints: 29, awayPoints: 19 },
];
